<script lang="ts">
  ...
  const formattedDate = $derived(
    new Date(currentLastModifiedDate).toLocaleString(),
  );
</script>

<div class="modal-backdrop">
  <div class="modal conflict-modal" role="dialog" aria-modal="true" aria-label="Deployment conflict">
    <div>
    ...
    <p>
      The bundle was last modified in the org at <strong>{formattedDate}</strong>,
      which is newer than the version you loaded. The following files may have changed:
    </p>
