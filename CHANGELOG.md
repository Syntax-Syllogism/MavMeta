...
- Cart smoke-crawler coverage
- Refreshed smoke report UI

### Changed

- Improved SOQL wrapping
- Quality of life improvements to publish script
...
- Paginated object explorer with infinite scroll and server-side pagination
- Warning before losing unsaved SOQL queries when switching organizations
- Improved error messages for LWC schema references

### Changed

- Improved organization environment detection with IsSandbox support
- Enhanced dev-hub environment display in OrgDirectory
- Fixed OrgDirectory overflow handling

### Fixed

- Corrected error handling for tooling API bug
